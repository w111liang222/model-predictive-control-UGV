...
{
int dummy;
/** Matrix of size: 26 x 7 (row major format)
 * 
...
/** Matrix of size: 175 x 2 (row major format) */
real_t evGu[ 350 ];
...
real_t objValueOut[ 40 ];

/** Matrix of size: 175 x 7 (row major format) */
real_t Q1[ 1225 ];

/** Matrix of size: 175 x 5 (row major format) */
real_t Q2[ 875 ];
...
/** Matrix of size: 2275 x 2 (row major format) */
real_t E[ 4550 ];
